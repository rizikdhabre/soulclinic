...
describe("Firebase diagnostic classification, separate from fallback authorization", () => {
  ...
  it.each([
    ...
    ["auth/network-request-failed", "initialize", "firebase_sdk", "technical_setup", "eligible"],
    ["auth/network-request-failed", "confirm", "firebase_sdk", "verification_technical", "eligible"],
